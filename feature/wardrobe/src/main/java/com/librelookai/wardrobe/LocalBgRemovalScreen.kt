...
import com.librelookai.feature.wardrobe.R
import com.librelookai.core.designsystem.R as DsR

/**
 * Full-screen review dialog hosted by the app shell (AppContent). When [WardrobeViewModel]'s
            ...
            Row(
                ...
                if (skippable) {
                    OutlinedButton(
                        ...
                        LocalWardrobeCostBadge.current?.invoke(com.librelookai.gemini.GeminiActionId.REMOVE_BACKGROUND, rawFilePath)
