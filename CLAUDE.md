...
- Calendar / wear-Stats (Outfits sub-tabs), Wardrobe stats sheet, Usage/Costs (Settings tab) → archive § "Insights tab" (pages redistributed; Insights tab removed)
